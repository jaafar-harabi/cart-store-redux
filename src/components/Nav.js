  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        ...
        className="p-1 font-normal text-lg hover:text-xl responsive"
      >
      ...
      <Typography
        ...
        className="p-1 font-normal text-lg  ml-5 hover:text-xl"
      >
      ...
      <Typography
        ...
        className="p-1 font-normal text-lg mr-10 ml-5 hover:text-xl"
      >
        Register
      </Typography>
      <Typography>
